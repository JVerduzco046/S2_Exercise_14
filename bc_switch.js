...
function setupStyles() {
    // Creat a link element for the paghe view styels
    ...
    //appemd the link element tot he doc head
    document.head.appendChild(pageStyle);

    pageStyle.disabled = true;
    //Insert somm buttons ofr the swicth
    ...
    // append an embedede style sheet to the document head
